...
You should not add extra error handling or logging unless specifically requested in the prompt, you
should implement the simplest, minimalist solution that meets the requirements. This is because
